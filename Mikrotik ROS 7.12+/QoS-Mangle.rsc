...
/ip firewall mangle add action=mark-packet chain=forward connection-mark=Download-conn in-interface=ether1 new-packet-mark=Download-pkt-in passthrough=no
/ip firewall mangle add action=mark-packet chain=forward connection-mark=Download-conn new-packet-mark=Download-pkt-out out-interface=ether1 passthrough=no
/ip firewall mangle add action=change-dscp chain=forward connection-mark=Browser-conn new-dscp=14
/ip firewall mangle add action=mark-packet chain=forward connection-mark=Browser-conn in-interface=ether1 new-packet-mark=Browser-pkt-in passthrough=no
/ip firewall mangle add action=mark-packet chain=forward connection-mark=Browser-conn new-packet-mark=Browser-pkt-out out-interface=ether1 passthrough=no
...
/ip firewall mangle add action=mark-packet chain=forward connection-mark=Games-conn in-interface=ether1 new-packet-mark=Games-pkt-in passthrough=no
/ip firewall mangle add action=mark-packet chain=forward connection-mark=Games-conn new-packet-mark=Games-pkt-out out-interface=ether1 passthrough=no
/ip firewall mangle add action=change-dscp chain=forward connection-mark=IPCALL-conn new-dscp=40
/ip firewall mangle add action=mark-packet chain=forward connection-mark=IPCALL-conn in-interface=ether1 new-packet-mark=IPCALL-pkt-in passthrough=no
/ip firewall mangle add action=mark-packet chain=forward connection-mark=IPCALL-conn new-packet-mark=IPCALL-pkt-out out-interface=ether1 passthrough=no
/ip firewall mangle add action=change-dscp chain=forward connection-mark=NetServ-conn new-dscp=48
/ip firewall mangle add action=mark-packet chain=forward connection-mark=NetServ-conn in-interface=ether1 new-packet-mark=NetServ-pkt-in passthrough=no
/ip firewall mangle add action=mark-packet chain=forward connection-mark=NetServ-conn new-packet-mark=NetServ-pkt-out out-interface=ether1 passthrough=no
/ip firewall mangle add action=change-dscp chain=forward connection-mark=no-mark-conn new-dscp=0
/ip firewall mangle add action=mark-packet chain=forward connection-mark=no-mark-conn in-interface=ether1 new-packet-mark=no-mark-pkt-in passthrough=no
/ip firewall mangle add action=mark-packet chain=forward connection-mark=no-mark-conn new-packet-mark=no-mark-pkt-out out-interface=ether1 passthrough=no
...
/ip firewall mangle add action=mark-connection chain=Conn-mark dscp=!46 new-connection-mark=Browser-conn passthrough=no port=80,443,8080 protocol=tcp
/ip firewall mangle add action=mark-connection chain=Conn-mark dscp=!46 new-connection-mark=Browser-conn passthrough=no port=80,443,8080 protocol=udp
...
/ip firewall mangle add action=mark-connection chain=Conn-mark new-connection-mark=NetServ-conn passthrough=no port=53,67,68,123,853,5222,5228,5353 protocol=udp
/ip firewall mangle add action=mark-connection chain=Conn-mark new-connection-mark=NetServ-conn passthrough=no port=53,67,68,123,853,5222,5228,5353 protocol=tcp
...
/ip firewall mangle add action=mark-connection chain=input comment="NetServices Router as HW Device" connection-mark=no-mark new-connection-mark=Router-conn passthrough=no
...
/ip firewall mangle add action=mark-connection chain=output connection-mark=no-mark new-connection-mark=Router-conn passthrough=no
